...
use crate::msg::{ChannelResponse, ExecuteMsg, ListChannelsResponse, QueryMsg, TransferMsg};
...
fn setup_and_query() {
    ...
    let err = query(
        ...
        .unwrap_err();
    assert_eq!(err, StdError::not_found("andromeda_potal_ado::state::ChannelInfo"));
}
